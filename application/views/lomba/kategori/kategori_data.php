							...
							foreach ($row->result() as $key => $data) { ?>
								<tr>
									...
									<td class="text-center" width="150px">
										<a href="<?= base_url('kategori/edit/' . $data->kategori_id) ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Update</a>
										<a href="<?= base_url('kategori/del/' . $data->kategori_id) ?>" class="btn btn-danger btn-xs " id="tmblhps"><i class="fa fa-trash"></i>Delete</a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
