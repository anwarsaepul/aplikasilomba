                        ...
                        <div class="row">
                                ...
                                <div class="border-end d-flex justify-content-md-center">
                                    <div class="mx-2 mx-md-0 me-md-5">
                                        <div class="badge badge-circle bg-soft-danger">
                                            <svg class="bi bi-person-fill" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#F53838" viewBox="0 0 16 16">
                            ...
                            <div class="col-4">
                                <div class="d-flex justify-content-md-center">
                                    ...
                                    <div>
                                        <h1 class="fw-bolder text-1000 mb-0">4 </h1>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 col-lg-5 text-center text-md-start">
                        ...
                        <p> Persyaratan peserta lomba menembak ESC Sukabumi 2021</p>
                        <div class="d-flex">
                            ...
                            <p class="ms-2">Peserta Lomba adalah Perorangan, Anggota Club atau <br>Komunitas yang berada di
                                wilayah Sukabumi</p>
                        </div>
                        <div class="d-flex">
                            <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                            ...
                            <p class="ms-2">Usia maksimal 18 tahun untuk kategori pelajar</p>
                        </div>
                        <div class="d-flex">
                            <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                            </svg>
                            <p class="ms-2">Membayar uang pendaftran Rp 25.000</p>
                        </div>
                        <div class="d-flex">
                            <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                            </svg>
                            <p class="ms-2">Diperbolehkan mendaftar lebih dari satu kategori</p>
                        </div>
                        <div class="d-flex">
                            <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                            </svg>
                            <p class="ms-2">peserta diwajibkan membaca, mengetahui dan <br>memahami peraturan-peraturan yang ditentukan panitia</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-5 text-center">
                        <h2>Lokasi Tanding</h2>
                        <p> Lapang Secapa <br> Jl. Bayangkara no 4 Gunung Puyuh Kota Sukabumi</p>
                    </div>
                    <div class="pt-12">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d18842.61150144784!2d107.57888002947051!3d-6.870089399577678!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6eadf73db7d%3A0x3a11da7f483413a7!2sLapangan%20Krida%20Wiradhika%20SECAPA%20AD!5e0!3m2!1sid!2sid!4v1624017046475!5m2!1sid!2sid" class="d-block w-100" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
            <!-- end of .container-->
                ...
                <div class="row justify-content-center">
                    ...
                    <section class="py-4">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="assets/img/gallery/logoesc.png" alt="" height="30" /></div>
                            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="assets/img/gallery/perbakin.png" alt="" height="30" /></div>
                        </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    ...
                    <section class="py-3">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="assets/img/gallery/bjb.jpg" alt="" height="10" /></div>
                            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="assets/img/gallery/kodim.png" alt="" height="10" /></div>
                            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="assets/img/gallery/roboratory.jpg" alt="" height="10" /></div>
                        </div>
                </div>
            </div>
        </section>
        ...
        <!-- ============================================-->
        <!-- <section> begin ============================-->
        <section class="bg-200 pt-4 pb-0">



            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6 mb-2"><a href="#"><img class="d-inline-block align-middle" src="assets/img/icons/logoesc.png" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">ESC<span class="fw-bold">sukabumi</span></span></a>
                        <p class="my-3"> <span class="fw-medium">ESCsukabumi</span> adalah sebuah situs yang memberikan informasi tentang perlombaan tembak.</p>
                        ...
                        <p class="text-400 my-3">&copy; 2021 ESCsukabumi by:zhap</p>
                    </div>
    ...
    <div style="position:fixed;right:25px;bottom:25px;">
        <a href="https://api.whatsapp.com/send?phone=+6285723369119&text=Assalamualaikum, saya butuh bantuan terkait lomba, apa bisa dibantu ?" target="_blank">
            <button style="background:#32C03C;vertical-align:center;height:45px;border-radius:1px; color:white;">
